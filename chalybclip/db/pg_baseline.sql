...
-- Postgres baseline equivalent to SQLite migrations through v58.
...
CREATE TABLE autopublish_settings (
    ...
    updated_at  TEXT NOT NULL, score_threshold double precision NOT NULL DEFAULT 0.6, tag_suffix TEXT NOT NULL DEFAULT '', growth_engine bigint NOT NULL DEFAULT 0, growth_min_score bigint NOT NULL DEFAULT 40, daily_clip_budget bigint,
    FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
);
...
CREATE TABLE brand_kits (
    ...
    created_at                TEXT NOT NULL,
    updated_at                TEXT NOT NULL
, default_platform           TEXT, banner_enabled_default     bigint NOT NULL DEFAULT 0, banner_show_context_default  bigint NOT NULL DEFAULT 0, banner_show_safezones_default bigint NOT NULL DEFAULT 0, clip_style                   TEXT, bottom_banner_style          TEXT, banner_live_badge_default    bigint NOT NULL DEFAULT 0, top_hook_enabled_default     bigint NOT NULL DEFAULT 0, top_hook_style_default       TEXT, target_platform TEXT, show_chalybclip_credit bigint NOT NULL DEFAULT 1, safe_schedule_enabled bigint NOT NULL DEFAULT 0, safety_policy_json TEXT, content_timezone TEXT NOT NULL DEFAULT 'UTC', show_chalybclip_outro bigint NOT NULL DEFAULT 1);
...
CREATE TABLE channel_watches (
    ...
    created_at          TEXT NOT NULL,
    updated_at          TEXT NOT NULL, polls_per_day bigint NOT NULL DEFAULT 1, failed_video_attempts_json TEXT NOT NULL DEFAULT '{}',
...
CREATE TABLE platform_pacing_rules (
    tenant_id          TEXT NOT NULL,
    platform           TEXT NOT NULL,
    max_per_day        bigint NOT NULL,
    min_gap_minutes    bigint NOT NULL,
    caption_min_chars  bigint NOT NULL DEFAULT 0,
    caption_max_chars  bigint NOT NULL DEFAULT 2200,
    hashtag_min        bigint NOT NULL DEFAULT 0,
    hashtag_max        bigint NOT NULL DEFAULT 30,
    jitter_minutes     bigint NOT NULL DEFAULT 0,
...
CREATE TABLE zernio_publishes (
    ...
    content     TEXT,
    created_at  TEXT NOT NULL, status TEXT, platforms_json TEXT, updated_at TEXT, options_json TEXT, scheduled_for TEXT,
    FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
);
...
CREATE TABLE clip_growth_scores (
...
CREATE INDEX idx_clip_growth_scores_tenant
